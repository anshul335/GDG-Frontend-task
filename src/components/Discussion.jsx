...
const Discussion = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto px-6 py-20 gap-5">
    {/* Left Section - Images */}
    <div className="relative w-md max-w-xl ml-25 mt-10 ">
        <div className='absolute w-50 h-50 bg-[#73BCFF] rounded-3xl top-0 -left-19 -z-15 '></div>
        
        <div className='w-20 h-20 rounded-full bg-[#73BCFF] flex items-center justify-center absolute right-8 -top-22  -z-10'>
            <div className='w-14 h-14 rounded-full bg-white'></div>
        </div>
        <div className='inline-block w-0 h-0 border-solid rotate-[81deg] border-t-0 border-r-[10px] border-l-[10px] border-b-[17.3px] border-l-transparent border-r-transparent border-t-transparent border-b-[#FBA333] absolute -right-6 -top-4'></div>
    ...
    <div className="max-w-md">
        ...
        One-on-One <span className="text-[#F48C06]">Discussions</span>
        </h2>
