...
const Tools = () => {
  return (
    ...
    {/* Text Section */}
    <div className="max-w-100 mx-auto text-center md:text-left">
    ...
    {/* Image Section */}
    <div className="relative max-w-100 mx-auto h-110 flex justify-center">
        ...
        <div className='w-15 h-15 rounded-2xl bg-[#f5f5f5] absolute  z-20 top-25 -left-10 flex items-center justify-center '>
        ...
        <div className='absolute w-45 h-45 bg-[#ff6a6a] rounded-full  top-10 left-15'></div>
        </div>
